...
if len(argv) < 3:
    print('need 2 input parameters, the first one is training_file_path path, the second one is wordvecotr binary file path, ')
    exit()
...
saved_model_name = 'insurance_benefit.h5'
